! function() {
    ...
    var t = function(t) {
        var e = document.getElementById(t.mainElement),
            ...
            n = { container: e, sections: s, animateTime: t.animateTime || .7, animateFunction: t.animateFunction || "ease", maxPosition: s.length - 1, currentPosition: 0, displayDots: "undefined" == typeof t.displayDots || t.displayDots, dotsPosition: t.dotsPosition || "left" };
    ...
    t.prototype.init = function() {
    ...
    }, t.prototype.buildSections = function() { for (var t = this.defaults.sections, e = 0; e < t.length; e++) t[e].setAttribute("data-index", e); return this }, t.prototype.buildDots = function() {
        ...
        }, this.changeCurrentPosition = function(t) { "" !== t && (s.defaults.currentPosition = t, location.hash = s.defaults.currentPosition) }, this.registerIeTags = function() { document.createElement("section") }, this.updateClass = function(t, e, s) { return 1 == t ? s += " " + e : 2 == t ? s.replace(e, "") : void 0 }, this
    }, window.fullScroll = t
}();